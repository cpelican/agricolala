...
The Playwright tests run the app against a dedicated e2e PostgreSQL database in a **mobile viewport only** (Pixel 5). See [e2e/TESTING.md](e2e/TESTING.md) for conventions, waits, and demo videos (`npm run test:e2e:demo`).
