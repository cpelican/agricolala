...
export function AddParcelDialog({ open, onOpenChange, selectedLocation }: AddParcelDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Add a new parcel to your vineyard management system</DialogDescription>
        </DialogHeader>
